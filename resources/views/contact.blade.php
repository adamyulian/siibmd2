<x-layouts.app>
  ...
  ```
-->
<div class="px-6 py-16 bg-transparent">
    <div class="max-w-2xl mx-auto text-center">
      <h2 class="text-3xl font-bold tracking-tight text-gray-900">Hubungi Kami</h2>
      <p class="mt-2 text-lg leading-8 text-gray-600">"Hubungi kami untuk informasi lebih lanjut atau potensi kerja sama."</p>
      <button type="submit" class="mt-6 mx-auto w-1/3 rounded-md bg-teal-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-teal-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600">Hubungi via Whatsapp Sekarang!!</button>
    </div>
      ...
      <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        ...
        <div class="sm:col-span-2">
          ...
          <div class="relative mt-2.5">
            <div class="absolute inset-y-0 left-0 flex items-center">
              ...
              <select id="country" name="country" class="h-full py-0 pl-4 text-gray-400 bg-transparent border-0 rounded-md bg-none pr-9 focus:ring-2 focus:ring-pink-500 focus:ring-inset sm:text-sm">
                <option>US</option>
                <option>CA</option>
                <option>EU</option>
              </select>
        ...
        <div class="flex gap-x-4 sm:col-span-2">
          <div class="flex items-center h-6">
            ...
            <button type="button" class="flex flex-none w-8 p-px transition-colors duration-200 ease-in-out bg-gray-200 rounded-full cursor-pointer ring-1 ring-inset ring-gray-900/5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600" role="switch" aria-checked="false" aria-labelledby="switch-1-label">
